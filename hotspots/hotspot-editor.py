...
if __name__ == '__main__':
    ...
    ap.add_argument("--filename", required=False, default="hotspots.csv",
                    help="Optional[hotspots.csv] Filename to save hotspot data")
            ...
            if Path(filename).exists():
                ...
                with open(filename, "r") as f:
                    ...
                    for row in csv_reader:
                        ...
                        hot_spots.append([int(row[0] * frame_shape[1]), int(row[1] * frame_shape[0]),
                                          int(row[2] * (frame_shape[0] * frame_shape[1]))])
